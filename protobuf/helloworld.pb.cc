...
const ::google::protobuf::uint32 TableStruct::offsets[] = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Book, opt_),
  1,
  0,
  2,
};
...
const int Book::kOptFieldNumber;
...
Book::Book()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:lm.Book)
}
Book::Book(const Book& from)
  ...
  // @@protoc_insertion_point(copy_constructor:lm.Book)
}
...
Book::~Book() {
  // @@protoc_insertion_point(destructor:lm.Book)
  SharedDtor();
}
...
void Book::Clear() {
// @@protoc_insertion_point(message_clear_start:lm.Book)
  if (has_name()) {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:lm.Book)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:lm.Book)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:lm.Book)
  return false;
#undef DO_
}
...
void Book::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:lm.Book)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_end:lm.Book)
}

::google::protobuf::uint8* Book::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic;  // Unused
  // @@protoc_insertion_point(serialize_to_array_start:lm.Book)
  // required int32 id = 1;
  if (has_id()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lm.Book)
  return target;
}

size_t Book::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:lm.Book)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:lm.Book)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:lm.Book)
  GOOGLE_DCHECK_NE(&from, this);
  const Book* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Book>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:lm.Book)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:lm.Book)
    MergeFrom(*source);
  }
}

void Book::MergeFrom(const Book& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:lm.Book)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
...
// @@protoc_insertion_point(generalized_copy_from_start:lm.Book)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:lm.Book)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// optional int32 opt = 3;
bool Book::has_opt() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
void Book::set_has_opt() {
  _has_bits_[0] |= 0x00000004u;
}
void Book::clear_has_opt() {
  _has_bits_[0] &= ~0x00000004u;
}
void Book::clear_opt() {
  opt_ = 0;
...
::google::protobuf::int32 Book::opt() const {
  // @@protoc_insertion_point(field_get:lm.Book.opt)
  return opt_;
}
void Book::set_opt(::google::protobuf::int32 value) {
  set_has_opt();
  opt_ = value;
