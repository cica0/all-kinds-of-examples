...
class RequestBuilder:
    ...
    def BuildUserProfileServiceRequest(self):
        ...
        ui_request.search_type = SEARCH_TYPE.PUSH_DOC
    ...
    def BuildUserRequest(self):
        ...
        #user_req.uid = "081009632256849"
        #user_req.uid = "2BFA510F-CB87-4A8F-9D41-0018C4C33739"
        user_req.uid = "000000849549852"
    ...
    def BuildDeviceInfo(self, device_type, device_uuid, os_type):
        ...
        device_id = DeviceID()
        #device_id.devid = "00000059383157"
        device_id.devid = "000B7B18-FA27-4720-A2F7-D8F6C1A3B722"
...
if __name__ == '__main__':
    print "start connect"
    #client = RequestClient("10.200.128.169",8019)
    client = RequestClient("127.0.0.1",8018)
